...
dataset_src_path = 'E:/ImgSensNet_dataset_mat'
origin_imgs_src_path = 'E:/ImgSensNet_dataset_mat/feature1'
lbl_src_path = 'E:/ImgSensNet_videos'
...
np.save('E:/Yyz_Personal/Research/本科生科研/UAV SensingImgNet/Codes/trained_model_3d_v1.npy', train_imgset_mean)
...
# First Conv Layer
model.add(Conv3D(32, (3, 3, 1), padding='valid', input_shape=SHAPE))
...
# Third Conv Layer
model.add(Conv3D(16, (3, 3, 4), padding='valid'))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(MaxPooling3D(pool_size=(2, 2, 1)))
model.add(Dropout(dropout))
