...
dataset_save_path = 'E:/ImgSensNet_dataset_mat' # matrix val. scaled to [0,1]
...
for each_rawimgs_dir in rawimgs_dir:
    ...
    for each_img in raw_imgs:
        ...
        # print(darkch_refined)
        np.save(img_save_full_path + raw_img_name + '.npy', darkch_refined)
        ...
        # print(contrast)
        np.save(img_save_full_path + raw_img_name + '.npy', contrast)
        ...
        # print(saturation)
        np.save(img_save_full_path + raw_img_name + '.npy', saturation)
        ...
        # print(clr_atten)
        np.save(img_save_full_path + raw_img_name + '.npy', clr_atten)
        ...
        # print(hue)
        np.save(img_save_full_path + raw_img_name + '.npy', hue)
        ...
        # print(ch)
        np.save(img_save_full_path + raw_img_name + '.npy', ch)
